---
title: "How to Buy Property in Pakistan — Legal Steps, Taxes & Costs (2026-27)"
pubDate: 2026-06-26
summary: "A complete guide to buying residential or commercial property in Pakistan — from finding a property to transfer at the registrar's office, including all taxes, stamp duty, and the major Budget 2026-27 changes to withholding tax rates."
category: "investment"
readTime: "11 min read"
---

Buying property in Pakistan is one of the biggest financial decisions most families make. It is also one of the most confusing — stamp duties, withholding taxes, CVT, and DC rates can add 5–10% to your purchase cost if you are not prepared. This guide walks you through every step and every rupee.

> **Budget 2026-27 Update (effective July 1, 2026):** Major property tax relief has been announced. Section 236K (buyer WHT) is reduced to a flat **1.5%**, Section 236C (seller WHT) to a flat **2.75%**, and the controversial **Section 7E** (deemed rental income tax on undeveloped plots) has been **completely abolished**. All figures in this guide reflect the new regime.
...
|---|---|---|
| Withholding tax on purchase (Sec. 236K) | **1.5% flat** *(Budget 2026-27)* | — |
| Withholding tax on sale (Sec. 236C) | — | **2.75% flat** *(Budget 2026-27)* |
...
> **Example:** Buying a PKR 2 crore (PKR 20 million) property now costs PKR 3 lakh in buyer WHT (1.5%) — down from PKR 6–12 lakh under the old tiered structure. This is one of the biggest property tax cuts in Pakistan's history.
...
1. **Withholding tax on purchase (Sec. 236K)** — **1.5% flat** (effective July 1, 2026 per Finance Act 2026) via FBR payment
2. **Stamp duty** — 1–3% depending on province, paid at Provincial Revenue Department
...
## Budget 2026-27: What Changed for Property Buyers

Finance Act 2026 (effective July 1, 2026) made the most significant property tax changes in years:

| Change | Old Rate | New Rate |
|---|---|---|
| Section 236K — buyer WHT | 3% (filer) to 20% (non-filer on high-value) | **1.5% flat** |
| Section 236C — seller WHT | 4% (filer) to 10% (non-filer) | **2.75% flat** |
| Section 7E — deemed rental income on undeveloped plots | Taxed as if earning rental income | **Abolished** |

**Section 7E abolition** is particularly significant. Previously, owners of undeveloped plots were taxed on a "deemed" 5% rental return on the plot's fair market value — effectively penalizing landholders who hadn't constructed. This has been completely removed from the Income Tax Ordinance.

**Impact:** Buyers and sellers now face a simpler, significantly lower tax burden. The filer/non-filer differential for property WHT has been removed in favour of flat rates, encouraging market formalisation.

---

## Key Takeaways

- Property WHT has been dramatically cut — 236K to 1.5%, 236C to 2.75% (Budget 2026-27)
- Section 7E deemed rental income tax on undeveloped plots is abolished
