...
| Feature | Details |
|---|---|
| Profit rate (2026) | ~21% per annum |
| Payment | Monthly |
| Tenure | 3 years (renewable) |
| Minimum investment | PKR 500 |
| Maximum investment | PKR 30 lakh per person |
| Zakat | Exempt |
...
| Feature | Details |
|---|---|
| Profit rate (2026) | ~18.36% per annum |
| Payment | Monthly |
| Tenure | 3 years |
...
**Example:** Invest PKR 10 lakh in RIC → receive approximately **PKR 15,300/month** in profit.
...
| Feature | Details |
|---|---|
| Profit rate (2026) | ~18.48% per annum |
...
| Feature | Details |
|---|---|
| Profit rate (2026) | ~20.12% (effective at maturity) |
...
- Behbood Savings Certificates offer ~21% annual profit paid monthly — the best rate for eligible investors (women, seniors, widowers)
- Regular Income Certificates give ~18.36% with monthly payments — suitable for all adults
