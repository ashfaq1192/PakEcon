...
pubDate: 2026-06-26
summary: "Pakistan's National Savings Schemes profit rates updated June 10, 2026 — Behbood/PBA at 13.20%, RIC at 11.82%, DSC at 10.44%. Complete guide to all NSS types, how to invest online, and comparison with bank deposits."
category: "investment"
readTime: "9 min read"
---
...
> **Rates updated June 10, 2026.** CDNS revised profit rates following the SBP's April 2026 policy rate hike (10.5% → 11.5%). All rates below reflect the June 10, 2026 revision. Check [savings.gov.pk/latest-profit-rates](https://savings.gov.pk/latest-profit-rates/) for real-time updates.
...
| **Profit rate** | 10.44–13.20% (June 2026, varies by scheme) | 10–12% (1-year FD) |
...
| Feature | Details |
|---|---|
| Profit rate (June 2026) | **13.20% per annum** |
| Payment | Monthly |
...
| Feature | Details |
|---|---|
| Profit rate (June 2026) | **11.82% per annum** |
| Payment | Monthly |
| Tenure | 5 years |
| Minimum investment | PKR 500 |
...
**Example:** Invest PKR 10 lakh in RIC → receive approximately **PKR 8,373/month** in profit (net of 15% WHT for filers at 11.82%).
...
| Feature | Details |
|---|---|
| Profit rate (June 2026) | **12.40%** (first 5 periods) / **13.60%** (6th period) |
...
| Feature | Details |
|---|---|
| Profit rate (June 2026) | **10.44% per annum** (paid at maturity) |
| Payment | At maturity only |
| Tenure | 10 years |
| Minimum investment | PKR 500 |
| Premature encashment | After 1 year |

Your money roughly doubles in approximately **7 years** at current rates (10.44% compounded).
...
| Feature | Details |
|---|---|
| Profit rate (June 2026) | **10.00% per annum** |
| Payment | Half-yearly |
...
- Behbood Savings Certificates offer **13.20%** annual profit paid monthly (June 2026) — the best rate for eligible investors (women, seniors, widowers)
- Regular Income Certificates give **11.82%** with monthly payments (June 2026) — suitable for all adults
