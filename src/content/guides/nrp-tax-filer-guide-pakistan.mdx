---
title: "NRP Tax Filer Guide: How Overseas Pakistanis Register as Tax Filers (2026-27)"
pubDate: 2026-05-18
...
| Transaction | Non-Filer Rate | Active Filer Rate | Note |
|---|---|---|---|
| **Property purchase** (Section 236K) | Higher rate | **1.5%** | Significantly reduced in Budget 2026-27 |
| **Property sale** (Section 236C) | Higher rate | **2.75%** | Reduced from previous rates under Finance Act 2026 |
| **International card WHT** | Higher rate | **0.5%** | Reduced from 5% in Budget 2026-27 |
| **National Savings WHT** | 30% of profit | **15% of profit** | Unchanged |
| **Bank cash withdrawal** (Section 231A, above PKR 50K) | 0.6% | **0%** | Full exemption for filers |
| **Vehicle registration** | Higher rate | Lower rate | Varies |
| **Prize bond winnings** | 25% | **15%** | 10% saving on each prize |

Budget 2026-27 (Finance Act 2026) significantly reduced property transaction taxes for filers — Section 236C and 236K rates were cut by up to 50% compared to previous years. Even at the new lower rates, filer status remains the single biggest money-saver for overseas Pakistanis who regularly buy or sell property in Pakistan.

> **Note:** Always verify the latest rates at [fbr.gov.pk](https://fbr.gov.pk) before transacting, as FBR periodically updates withholding tax schedules.
